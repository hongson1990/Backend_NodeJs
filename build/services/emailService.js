      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"Son" <hongsonndvn2023@gmail.com>',
            // sender address
...
var getBodyHTMLEmail = function getBodyHTMLEmail(dataSend) {
  var language = dataSend.language;
  var result = '';
  if (language === 'vi') {
    result = "\n        <h3>Xin ch\xE0o ".concat(dataSend.patientName, "!</h3>\n        <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online tr\xEAn Bookingcare</p>\n        <p>Th\xF4ng tin \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh:</p>\n        <div><b>Th\u1EDDi gian: ").concat(dataSend.time, "</b></div>\n        <div><b>B\xE1c s\u0129: ").concat(dataSend.doctorName, "</b></div>\n\n        <p>N\u1EBFu c\xE1ch th\xF4ng tin tr\xEAn l\xE0 \u0111\xFAng s\u1EF1 th\u1EADt, vui l\xF2ng click v\xE0o \u0111\u01B0\u1EDDng link b\xEAn d\u01B0\u1EDBi \u0111\u1EC3 x\xE1c nh\u1EADn \n        v\xE0 ho\xE0n t\u1EA5t th\u1EE7 t\u1EE5c \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh.</p>\n        <div><a href=").concat(dataSend.redirectLink, " target=\"_blank\">Click here</a></div>\n\n        <div>Xin ch\xE2n th\xE0nh c\xE1m \u01A1n</div>\n        ");
  }
  if (language === 'en') {
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  ...
  var result = '';
  if (language === 'vi') {
    result = "\n        <h3>Xin ch\xE0o ".concat(dataSend.patientName, "!</h3>\n        <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online tr\xEAn Bookingcare th\xE0nh c\xF4ng</p>\n        <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c/h\xF3a \u0111\u01A1n \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m</p>\n\n        <div>Xin ch\xE2n th\xE0nh c\xE1m \u01A1n</div>\n        ");
  }
  if (language === 'en') {
    result = "\n        <h3>Dear ".concat(dataSend.patientName, "!</h3>\n        <p>You received this email because you booked an online medical appointment on Bookingcare</p>\n        <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c/h\xF3a \u0111\u01A1n \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m</p>\n        <div>Thank you very much</div>\n        ");
  }
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return transporter.sendMail({
            ...
            attachments: [{
              filename: "remedy-".concat(dataSend.patientId, "-").concat(dataSend.patientName, ".jpg"),
